...
cc.View4 = View.extend({
  ...
  ctor: function() {
     ...
     *
     */
    this.button1 = new Button(resources.main.button1, this, 1, 1, 1, 2, Game.onPlaySingle.bind(Game), 'single');
    this.button2 = new Button(resources.main.button1, this, 1, 1, 1, 2, Game.onPlayOnline.bind(Game), 'online');
